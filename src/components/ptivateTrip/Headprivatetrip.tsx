...
interface HeadProps {
  ...
  tohead_en?: string | null;
  fromhead_ar?: string | null;
  tohead_ar?: string | null;
  seats_number?: number;
  car?: string;
  address_from?: string;
  address_to?: string;
...
export const Headprivatetrip: FC<HeadProps> = ({
  ...
  const handleBackClick = () => {
   ...
   const address_To: any =  address_to === undefined ? '' : address_to
 
  return (
      <div
        className={` relative flex h-[20vh] w-full flex-col bg-[#1d4179] ltr:py-2 rtl:ml-2 mb-10`}
      >
        {/* top nav */}
