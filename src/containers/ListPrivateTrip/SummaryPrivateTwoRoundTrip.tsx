...
export const SummaryPrivateTwoRoundTrip = () => {
  ...
  const ti:any = window.localStorage.getItem("private_time")
  const time = JSON.parse(ti)

  const Af:any = window.localStorage.getItem("AddressFromOne")
  const AddressFromOne = JSON.parse(Af)
  const AT:any = window.localStorage.getItem("AddressToOne")
  const AddressToOne = JSON.parse(AT)

  const tr:any = window.localStorage.getItem("trip_Id")
  const trip_Id = JSON.parse(tr)

 
  const [data_from_summary , setdata_from_summary]:any = useState()
  ...
  useEffect(() => {
    ...
    const OneRoundPost = {
      ...
      return: {
        date: `${end_date}  ${time}`,
        from_address_id: AddressToOne?.id,
        to_address_id: AddressFromOne?.id
      }
    };
      axios
      .post(
        `https://app.telefreik.com/api/v2/transports/private/trips/${trip_Id}/create-ticket`,
        OneRoundPost,
        {
          headers: {
  ...
  const PayNow = () => {
    const data = data_from_summary?.payment_url
    const token = localStorage.getItem("token");
    const config = {
      headers: {
        accept: "application/json, text/plain, /",
    ...
    if(data_from_summary) {
      ...
      <div className="container">
        <div className= {`m-auto mb-5 mt-10 flex w-full justify-between ${Styled.twoRoundSummaryContainerCard}`} >
          ...
          <div className="m-auto flex w-full items-center justify-center ">
            <div className="mt-5 flex w-[100%] flex-col items-center rounded-lg bg-[white]">
              <div className="mt-4 flex h-[auto] w-[98%] items-center justify-between  pb-1 pt-1">
                <div className="flex w-[90%] items-center justify-start rtl:justify-start">
                  <div className=" flex h-[100px] w-[100px] w-[40%] justify-center">
                    <img
                      src={data_from_summary?.trips[0]?.bus?.featured_image}
                  ...
                  <div className=" ml-10 flex  flex-col rtl:mr-10 rtl:justify-end">
                    <div className=" flex flex-col ">
                      <h3 className="text-[16px] font-[400] text-[#1E1E1E]  ">
                        {" "}
                        {data_from_summary?.trips[0]?.bus?.name}{" "}
                      </h3>
                      <p className=" text-[12px] rtl:text-right">
                        {" "}
                        {data_from_summary?.trips[0]?.bus?.model} &{" "}
                        {data_from_summary?.trips[0]?.bus?.year}{" "}
                      </p>
                    </div>
                    ...
                    <div className="items-left rtl:items-right mt-2 flex flex-col text-[12px] text-[#69696A]">
                      ...
                      <span className=" flex items-end justify-start  rtl:justify-start ">
                        ...
                        <h4 className="ml-1">
                          {data_from_summary?.trips[0]?.bus?.type?.seats_number}
                        </h4>{" "}
                      </span>
              ...
              <div className="mb-4  flex  w-[98%] items-center justify-between">
                ...
                <img src={`${data_from_summary?.trips[0]?.company_data?.logo}`} className="h-[40px] w-[70px]" />
                </div>
                  ...
                  <div className="flex flex-col">
                    <h3 className="text-[20px] font-[500] text-[black]">
                      <span className="mr-2 text-[20px] font-[500] rtl:ml-2">
                        {data_from_summary?.trips[0]?.total}
                      </span>{" "}
                    </h3>
          ...
          <div className="m-auto flex w-full items-center justify-center rtl:justify-end">
            <div className="mt-5 flex w-[100%] flex-col items-center rounded-lg bg-[white]">
              <div className="mt-4 flex h-[auto] w-[98%] items-center justify-between  pb-1 pt-1">
                <div className="flex w-[90%] items-center justify-start rtl:justify-start">
                  <div className=" flex h-[100px] w-[100px] w-[40%] justify-center">
                    <img
                      src={data_from_summary?.trips[1]?.bus?.featured_image}
                      className="h-[80px] w-[80px]"
                    />
                  </div>
                  ...
                  <div className=" ml-10 flex  flex-col rtl:mr-10 rtl:justify-end">
                    <div className=" flex flex-col ">
                      <h3 className="text-[16px] font-[400] text-[#1E1E1E]  ">
                        {" "}
                        {data_from_summary?.trips[1]?.bus?.name}{" "}
                      </h3>
                      <p className=" text-[12px] rtl:text-right">
                        {" "}
                        {data_from_summary?.trips[1]?.bus?.model} &{" "}
                        {data_from_summary?.trips[1]?.bus?.year}{" "}
                      </p>
                    </div>
                    ...
                    <div className="items-left rtl:items-right mt-2 flex flex-col text-[12px] text-[#69696A]">
                      ...
                      <span className=" flex items-end justify-start  rtl:justify-start ">
                        ...
                        <h4 className="ml-1">
                          {data_from_summary?.trips[1]?.bus?.type?.seats_number}
                        </h4>{" "}
                      </span>
              ...
              <div className="mb-4  flex  w-[98%] items-center justify-between">
                <div className="ml-3 rtl:mr-3">
                  <img src={`${data_from_summary?.trips[1]?.company_data?.logo}`} className="h-[40px] w-[70px]" />
                </div>
                ...
                <div className=" ">
                  <div className="flex flex-col">
                    <h3 className="text-[20px] font-[500] text-[black]">
                      <span className="mr-2 text-[20px] font-[500] rtl:ml-2">
                        {data_from_summary?.trips[1]?.total}
                      </span>{" "}
                    </h3>
                    <span className="text-[12px] text-[#69696A] rtl:ml-2 rtl:text-left">
                      {" "}
        ...
        <div className=" container mt-5 flex  h-auto w-full flex-col rounded-lg border-[16px] border-[#B9C4D5] bg-white pt-10 mb-5">
            ...
            <div className="flex flex-col items-baseline ">
              <span className="flex flex-col   ">
                <span className="mb-2 flex justify-start">
                  <h4 className=""> {data_from_summary?.trips[0]?.date} </h4>
                </span>
                <h4 className="">
                  {" "}
                  {data_from_summary?.trips[0]?.from_address?.name} |{" "}
                  {data_from_summary?.trips[0]?.to_address?.name}{" "}
                </h4>
              </span>
  
              <span className="mt-3 flex  flex-col ">
                <span className="mb-2 flex justify-start">
                  <h4 className=""> {data_from_summary?.trips[1]?.date} </h4>
                </span>
                <h4 className="">
                  {" "}
                  {data_from_summary?.trips[1]?.from_address?.name}  |  {data_from_summary?.trips[1]?.to_address?.name}
                  {" "}
                </h4>
              </span>
            </div>
            ...
            <div className="flex flex-col items-baseline ">
              <span className="flex flex-col   ">
                ...
                <h4 className="text-[16px] font-[400] text-[#1D4179]">
                  {" "}
                  {t(`${data_from_summary?.trips[0]?.total}`)}{" "}
                </h4>
              </span>
              <span className="mt-3 flex  flex-col ">
                <span className="mb-2 flex justify-end text-[16px] font-[400]">
                ...
                <h4 className="text-[16px] font-[400] text-[#1D4179]">
                  {" "}
                  {t(`${data_from_summary?.trips[1]?.total}`)}{" "}
                </h4>
              </span>
            </div>
          </div>
          ...
          <div className="flex w-full items-center  justify-between pb-5">
            <span className="text-[16px] font-[400] text-[]">
              {t("Discount")}
            </span>
            <span className="text-[16px] font-[400] text-[#1D4179]">{data_from_summary?.payment_fees_value}</span>
          </div>
          <div className="flex w-full items-center  justify-between pb-5">
            <span className="text-[16px] font-[400] text-[]">
              {t("Tax Included")}
            </span>
            <span className="text-[16px] font-[400] text-[#1D4179]">{data_from_summary?.payment_fees_percentage}</span>
          </div>
  
          <div className="flex w-full items-center  justify-between pb-10">
            <span className="text-[20px] font-[500] text-[]">{t("Total")}</span>
            <span className="text-[16px] font-[400] text-[#1D4179]">
              {t(`${data_from_summary?.tickets_totals}`)}
            </span>
          </div>
