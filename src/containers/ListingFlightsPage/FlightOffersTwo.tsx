...
export const FlightOffersTwo = () => {
 ...
 const {t} = useTranslation()
  ...
  const Max_Screen = () => {
    return (
        <div>
      <div className="container mb-3 mt-20 flex h-[400px] w-full flex-col rounded-[10px] bg-white pt-3">
        <div className="mt-3 flex w-full justify-start text-[16px] font-[400] text-[#1E1E1E]">
          <span className="mr-1">
            {Flight_Offers?.depart_trip?.segments[0]?.originPlace?.name}
          </span>
          <svg
            className="mr-1"
          ...
          >
            <path
              d="M17.25 9L21 12.75M21 12.75L17.25 16.5M21 12.75H3"
              stroke="#1E1E1E"
              stroke-width="1.5"
          ...
          <span className="mr-1">
            {Flight_Offers?.depart_trip?.segments[0]?.destinationPlace?.name}
          </span>
          <span className="mr-1">
            {Flight_Offers?.depart_trip?.arrivalDateTime}
          </span>
        </div>

        <div className="flex w-full justify-start">
          <div className="flex  h-[100px] w-[90%] items-center justify-between  ">
            <img
              src={Flight_Offers?.depart_trip?.carriers[0]?.imageUrl}
              alt="image here "
            />

            <div className="ml-3 flex flex-col items-start">
              <span className="text-[16px] font-[400] text-[#69696A]">
                {Flight_Offers?.depart_trip?.segments[0]?.originPlace?.iata}
              </span>
              <span className="text-[12px] font-[400] text-[#69696A]">
                {Flight_Offers?.depart_trip?.segments[0]?.arrivalDateTime?.substring(
                  11
                )}
              </span>
            </div>
            ...
            >
              <path
                d="M0 1H93.5"
                stroke="url(#paint0_linear_2088_1234)"
                stroke-dasharray="2 2"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_2088_1234"
                  x1="0"
                  y1="1.5"
                  x2="93.5"
                  y2="1.5"
            ...
            <div className="relative">
              ...
              <div className="absolute left-[0%] top-[100%] flex flex-col items-center">
                ...
                >
                  <path
                    d="M60 1.25L63.75 5M63.75 5L60 8.75M63.75 5H1.25H45.75"
                    stroke="#69696A"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <div className="flex flex-col items-start ">
              <span className="text-[16px] font-[400] text-[#69696A]">
                {
                  Flight_Offers?.depart_trip?.segments[0]?.destinationPlace
                    ?.iata
                }
              </span>
              <span className="text-[12px] font-[400] text-[#69696A]">
                {Flight_Offers?.depart_trip?.segments[0]?.departureDateTime?.substring(
                  11
                )}
              </span>
            </div>
            ...
            <div className="flex justify-center ">
              ...
              >
                <path
                  d="M13.6086 4.05245V1.00659H6.39141V4.05241H0V18.9934H20V4.05241L13.6086 4.05245ZM7.56328 2.17847H12.4367V4.05241H7.56328V2.17847ZM3.53895 17.8215H1.17188V5.22425H3.53895V17.8215ZM15.2892 17.8215H4.71082V5.22425H15.2892V17.8215ZM18.8281 17.8215H16.4611V5.22425H18.8281V17.8215Z"
                  fill="#69696A"
                />
              </svg>
              <div className="flex flex-col items-start text-[12px] font-[400] text-[#69696A]">
        ...
        <div className="mt-3 flex w-full justify-start text-[16px] font-[400] text-[#1E1E1E]">
          <span className="mr-1">
            {Flight_Offers?.return_trip?.segments[0]?.originPlace?.name}
          </span>
          <svg
            className="mr-1"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="mr-1">
            {Flight_Offers?.return_trip?.segments[0]?.destinationPlace?.name}
          </span>
          <span className="mr-1">
            {Flight_Offers?.return_trip?.arrivalDateTime}
          </span>
        </div>
        ...
        <div className="flex w-full justify-start">
          <div className="flex  h-[100px] w-[90%] items-center justify-between  ">
            <img
              src={Flight_Offers?.return_trip?.carriers[0]?.imageUrl}
              alt="image here "
            />

            <div className="ml-3 flex flex-col items-start">
              <span className="text-[16px] font-[400] text-[#69696A]">
                {Flight_Offers?.return_trip?.segments[0]?.originPlace?.iata}
              </span>
              <span className="text-[12px] font-[400] text-[#69696A]">
                {Flight_Offers?.return_trip?.segments[0]?.arrivalDateTime?.substring(
                  11
                )}
              </span>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute left-[0%] top-[100%] flex flex-col items-center">
                <span className="text-[12px] font-[400] text-[#69696A]">
                  {Flight_Offers?.return_trip?.segments[0]?.durationInMinutes}{" "}
                  min
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-col items-start ">
              <span className="text-[16px] font-[400] text-[#69696A]">
                {
                  Flight_Offers?.return_trip?.segments[0]?.destinationPlace
                    ?.iata
                }
              </span>
              <span className="text-[12px] font-[400] text-[#69696A]">
                {Flight_Offers?.return_trip?.segments[0]?.departureDateTime?.substring(
                  11
                )}
              </span>
            </div>
            ...
            <span className='flex justify-start w-full text-[#69696A] text-[16px] font-[400] ' >Economy class, 1 adult</span>
            {
               ...
               <img  src={Flight_Offers?.depart_trip?.carriers[0]?.imageUrl} alt="image here " />
                ...
                <div className='flex justify-end items-center '>
                    ...
                    <a  href={`${item?.url}`}
                     className='ml-2 cursor-pointer flex justify-center items-center rounded-[10px] text-white bg-[#1D4179] w-[177px] h-[54px]'>{t("select")}</a>
                </div>
                    </div>
                   )
                })
  ...
  const Min_and_Medium_Screen = () => {
    return (
        <div>
      <div className="container mt-20 flex h-auto w-full flex-col rounded-[10px] bg-white pb-10 pt-3">
        <div className="mt-3 flex w-full justify-start text-[16px] font-[400] text-[#1E1E1E]">
          <span className="mr-1">
            {Flight_Offers?.depart_trip?.segments[0]?.originPlace?.name}
          </span>
      ...
      <div className="container mb-10 mt-10 flex w-full flex-col">
        ...
        {URLS?.map((item: any, index: any) => {
          return (
            <div
              key={index}
              className="mt-3 flex w-full items-center justify-center border-b-2 border-[#B9C4D5] pb-2"
            >
              ...
              <img src={item?.agent?.imageUrl} />
                ...
                <a
                  href={`${item?.url}`}
                  className="ml-2 flex h-[54px] w-[177px] cursor-pointer items-center justify-center rounded-[10px] bg-[#1D4179] text-white"
                >
                  select
                </a>
              </div>
  ...
  return (
    <div>
      <FlightHeader
        To={Flight_Offers?.return_trip?.segments[0]?.originPlace?.name}
        From= {Flight_Offers?.return_trip?.segments[0]?.destinationPlace?.name} 
      />

        <div>{screenSize.width > 850 ? Max_Screen() : Min_and_Medium_Screen()}</div>
