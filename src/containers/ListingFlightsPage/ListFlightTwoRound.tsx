       ...
       return (
        <div className='container flex flex-col h-auto bg-white mt-2 mb-2 rounded-[10px]' key={index}>
            ...
            <div className='flex justify-between w-full items-center mt-[32px]'>
              ...
              <div  className='flex justify-center items-center w-[145px] h-[39px] text-white bg-[#658FA9] rounded-[10px]'>
              <svg xmlns="http://www.w3.org/2000/svg" width="12" height="13" viewBox="0 0 12 13" fill="none" className='rtl:ml-3'>
